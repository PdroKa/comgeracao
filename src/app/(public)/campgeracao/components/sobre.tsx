            ...
            <div className="max-w-5xl mx-auto px-4 lg:px-6">
                <div className="grid md:grid-cols-2 gap-4 items-center">
                    ...
                    <div >
                        <h2
                            id="about-title"
                            className="text-center sm:text-center font-open mb-6 flex-1/2 text-2xl sm:text-4xl lg:text-5xl font-extrabold tracking-tight text-black"
                        >
                            O QUE É O{" "}
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-1 gap-1 mt-8">
                        <div className="relative rounded-lg overflow-hidden">
                            <Image
                                ...
                                alt="Pessoas adorando no Camp Geração"
                                width={700}
                                height={500}
